...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Tue Aug 4 12:53:44 2009
...
SOURCES       = rsrmainwindow.cpp \
		...
		dbconnector.cpp \
		webpagewindow.cpp \
		addfeeddialog.cpp moc_rsrmainwindow.cpp \
...
$(TARGET): ui_rsrmainwindow.h ui_webpagewindow.h ui_addfeeddialog.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ReallySimpleReader1.0.0/ && $(COPY_FILE) --parents rsrmainwindow.h item.h channel.h reallysimplereader.h dbmanager.h httpdownloader.h xmlparser.h feedmodel.h channellistmodel.h dbconnector.h webpagewindow.h addfeeddialog.h .tmp/ReallySimpleReader1.0.0/ && $(COPY_FILE) --parents rsrmainwindow.cpp item.cpp channel.cpp reallysimplereader.cpp dbmanager.cpp httpdownloader.cpp xmlparser.cpp main.cpp feedmodel.cpp channellistmodel.cpp dbconnector.cpp webpagewindow.cpp addfeeddialog.cpp .tmp/ReallySimpleReader1.0.0/ && $(COPY_FILE) --parents rsrmainwindow.ui webpagewindow.ui addfeeddialog.ui .tmp/ReallySimpleReader1.0.0/ && (cd `dirname .tmp/ReallySimpleReader1.0.0` && $(TAR) ReallySimpleReader1.0.0.tar ReallySimpleReader1.0.0 && $(COMPRESS) ReallySimpleReader1.0.0.tar) && $(MOVE) `dirname .tmp/ReallySimpleReader1.0.0`/ReallySimpleReader1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ReallySimpleReader1.0.0
...
compiler_moc_header_make_all: moc_rsrmainwindow.cpp moc_reallysimplereader.cpp moc_dbmanager.cpp moc_httpdownloader.cpp moc_xmlparser.cpp moc_channellistmodel.cpp moc_dbconnector.cpp moc_webpagewindow.cpp moc_addfeeddialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_rsrmainwindow.cpp moc_reallysimplereader.cpp moc_dbmanager.cpp moc_httpdownloader.cpp moc_xmlparser.cpp moc_channellistmodel.cpp moc_dbconnector.cpp moc_webpagewindow.cpp moc_addfeeddialog.cpp
...
moc_webpagewindow.cpp: webpagewindow.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) webpagewindow.h -o moc_webpagewindow.cpp

moc_addfeeddialog.cpp: addfeeddialog.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) addfeeddialog.h -o moc_addfeeddialog.cpp
...
compiler_uic_make_all: ui_rsrmainwindow.h ui_webpagewindow.h ui_addfeeddialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_rsrmainwindow.h ui_webpagewindow.h ui_addfeeddialog.h
ui_rsrmainwindow.h: rsrmainwindow.ui
	/usr/lib/qt4/bin/uic rsrmainwindow.ui -o ui_rsrmainwindow.h

ui_webpagewindow.h: webpagewindow.ui
	/usr/lib/qt4/bin/uic webpagewindow.ui -o ui_webpagewindow.h

ui_addfeeddialog.h: addfeeddialog.ui
	/usr/lib/qt4/bin/uic addfeeddialog.ui -o ui_addfeeddialog.h
...
webpagewindow.o: webpagewindow.cpp webpagewindow.h \
		ui_webpagewindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o webpagewindow.o webpagewindow.cpp

addfeeddialog.o: addfeeddialog.cpp addfeeddialog.h \
		ui_addfeeddialog.h \
		dbmanager.h \
		httpdownloader.h \
		channel.h \
		item.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o addfeeddialog.o addfeeddialog.cpp
...
moc_webpagewindow.o: moc_webpagewindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_webpagewindow.o moc_webpagewindow.cpp
