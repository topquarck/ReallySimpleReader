...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Sat Jun 20 17:52:26 2009
...
SOURCES       = rsrmainwindow.cpp \
		...
		dbconnector.cpp \
		main.cpp \
		feedmodel.cpp moc_rsrmainwindow.cpp \
...
compiler_moc_header_make_all: moc_rsrmainwindow.cpp moc_reallysimplereader.cpp moc_dbmanager.cpp moc_httpdownloader.cpp moc_xmlparser.cpp moc_dbconnector.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_rsrmainwindow.cpp moc_reallysimplereader.cpp moc_dbmanager.cpp moc_httpdownloader.cpp moc_xmlparser.cpp moc_dbconnector.cpp
moc_rsrmainwindow.cpp: istatusbarviewer.h \
		rsrmainwindow.h
