...
# Generated by qmake (2.01a) (Qt 4.5.0) on: Wed Jun 24 12:37:59 2009
...
SOURCES       = rsrmainwindow.cpp \
		...
		feedtableview.cpp \
		feedstore.cpp \
		channellistmodel.cpp moc_rsrmainwindow.cpp \
		moc_reallysimplereader.cpp \
		moc_dbmanager.cpp \
		moc_httpdownloader.cpp \
		moc_xmlparser.cpp \
		moc_dbconnector.cpp \
		moc_feedtableview.cpp \
		moc_feedstore.cpp \
...
compiler_moc_header_make_all: moc_rsrmainwindow.cpp moc_reallysimplereader.cpp moc_dbmanager.cpp moc_httpdownloader.cpp moc_xmlparser.cpp moc_dbconnector.cpp moc_feedtableview.cpp moc_feedstore.cpp moc_channellistmodel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_rsrmainwindow.cpp moc_reallysimplereader.cpp moc_dbmanager.cpp moc_httpdownloader.cpp moc_xmlparser.cpp moc_dbconnector.cpp moc_feedtableview.cpp moc_feedstore.cpp moc_channellistmodel.cpp
...
moc_feedtableview.cpp: feedtableview.h
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) feedtableview.h -o moc_feedtableview.cpp
...
feedtableview.o: feedtableview.cpp feedtableview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o feedtableview.o feedtableview.cpp
...
moc_feedtableview.o: moc_feedtableview.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_feedtableview.o moc_feedtableview.cpp
